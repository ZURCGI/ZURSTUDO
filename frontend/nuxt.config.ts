    ...
    head: {
      ...
      meta: [
        ...
        { name: 'robots', content: 'index, follow' },
        {
          ...
          content: "default-src 'self'; img-src 'self' https://res.cloudinary.com data: blob:; media-src 'self' https://res.cloudinary.com data: blob:; connect-src 'self' http://localhost:3000 https://res.cloudinary.com https://api.cloudinary.com https://api.iconify.design data: blob:; font-src 'self' https://fonts.googleapis.com https://fonts.gstatic.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; script-src 'self' 'unsafe-inline'; worker-src 'self' blob:; frame-src https://www.instagram.com;"
        },
        // GEO
